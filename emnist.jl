...
heatmap(rotate(reshape(data[data_idx][1], (28, 28))), color = :greys, aspect_ratio=:equal)
...
begin
	...
	vline!([train_y[data_idx]], color=:black)
end
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "56b951f89a7227d4dbc58af19a259f5c6572c6b6"
