...
begin
	in_plot  = heatmap(rotate_flip(reshape(data[data_idx][1], (28, 28))), color = :greys, aspect_ratio=:equal)
	n.a[1] = copy(data[data_idx][1])
	forward!(n)
	out_plot = heatmap(rotate_flip(reshape(last(n.a), (28, 28))), color = :greys, aspect_ratio=:equal)
