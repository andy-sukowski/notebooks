...
begin
	in_plot  = heatmap(rotate(reshape(data[data_idx][1], (28, 28))), color = :greys, aspect_ratio=:equal)
	n.a[1] = copy(data[data_idx][1])
	forward!(n)
	out_plot = heatmap(rotate(reshape(last(n.a), (28, 28))), color = :greys, aspect_ratio=:equal)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "ecc278ba1ec0b0da40f457d39b3d8ae325f8d390"
