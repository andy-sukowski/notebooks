...
begin
	...
	inputs = gen_out.(train_y)
	outputs = [Float64.(vec(rotl90(train_x[:, :, i]))) for i in 1:data_len]
...
begin
	...
	forward!(n)
	heatmap(reshape(last(n.a), (28, 28)), color = :greys, aspect_ratio=:equal)
end
...
# ╔═╡ f2052880-5ba6-4811-b932-d6915a5ba695
...
begin
	plot(Σcosts[1:300], label="raw")
	kernel = [0.11 for i in 1:9]
	plot!(xcorr(Σcosts[1:300], kernel), label="smooth")
end

# ╔═╡ ca7c173f-4cfd-4b32-b554-ce984a2bf150
md"""## Visualize weights, biases, etc."""

# ╔═╡ e9bbcf64-813d-47e8-8edb-0ca4750d28b5
heatmap(reshape(n.b[2], (28,28)), aspect_ratio=1)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "dedf106290d39441158013e49cd903ce32a6a041"
